...
import { AxiosWebhookSenderRepository } from './webhook-sender/axios-webhook-sender.repository';
...
@Module({
  ...
  providers: [
    ...
    {
      provide: WebhookSenderRepository,
      useClass: AxiosWebhookSenderRepository,
    },
